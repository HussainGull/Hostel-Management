...
export default function CollectionChart(
    ...
    return (
        <Card className="w-full max-w-[260px] aspect-[13/15] flex-shrink flex flex-col gap-0 justify-start bg-transparent border-none cursor-pointer shadow-none">
            ...
            <span className="text-white font-bold text-[clamp(20px,4vw,40px)]">
              {percentage}%
            </span>
                    </div>
                </div>
